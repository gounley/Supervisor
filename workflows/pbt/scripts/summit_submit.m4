...
export PATH=/ccs/home/gounley1/summit/tensorflow-1.12-p3/9.2.148/bin:$PATH
...
export PYTHONHOME="/ccs/home/gounley1/summit/tensorflow-1.12-p3/anaconda3"
...
PYTHONPATH=/ccs/home/gounley1/summit/tensorflow-1.12-p3/anaconda3/lib/python3.6/site-packages:/ccs/home/gounley1/summit/tensorflow-1.12-p3/anaconda3/lib/python3.6:$PYTHONPATH
...
jsrun --nrs getenv(PROCS) --tasks_per_rs 1 --cpu_per_rs 1 --gpu_per_rs 1 --rs_per_host getenv(PPN) --latency_priority cpu-cpu --launch_distribution cyclic --bind packed:1 python $PBT_PY $PARAMS_FILE $EXP_DIR p3b3 $EXP_ID
